		...
		<form class="form-horizontal" name="myform" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath }/member/join_ok.do">
			...
			<div class="form-group">
				...
				<div class="col-md-10 clearfix">
					...
					<input type="button" value="우편번호 찾기" class="btn btn-warning" onclick='execDaumPostcode("postcode", "addr1", "addr2", "addr3")'/>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<label for="addr3" class="col-md-2">참고주소</label>
				<div class="col-md-4">
			...
			<div class="form-group">
				...
				<div class="col-md-10">
					<input type="file" name="profile_img" id="profile_img" class="form-control" placeholder="yyyy-mm-dd"/>
				</div>
			</div>
